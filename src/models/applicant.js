...
const applicantSchema = new mongoose.Schema({
  ...
  firstTimeHack: {type: Boolean, required: true},
  ...
  haveBeenToShell: {type: Boolean, required: true},
  likeAMentor: {type: Boolean, required: true},
  applicationStatus: {type: String, required: true},
  needReimburesment: {type: Boolean, required: true},
