...
const validateWorkshop = applicant => new Promise(async(resolve, reject) => {
...
const validateMentor = applicant => new Promise(async(resolve, reject) => {
...
const validateVolunteer = applicant => new Promise(async(resolve, reject) => {
...
const validateCandidate = applicant => new Promise(async(reject, resolve) => {
    if (!applicant.email) reject('Email was not defined');
